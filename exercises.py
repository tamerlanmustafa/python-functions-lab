...
apply_discount = lambda price, discount_rate: int(price -(price*discount_rate/100))
...
# convert_temperature = lambda temp, unit: int( ((temp * 9/5 + 32) if unit == 'C' else ((temp - 32)*5/9))) lambda expression looks unreadable here
